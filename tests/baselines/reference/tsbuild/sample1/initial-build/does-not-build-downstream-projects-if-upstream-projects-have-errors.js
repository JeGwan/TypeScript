...
[[90m12:01:00 AM[0m] Project 'src/tests/tsconfig.json' can't be built because its dependency 'src/logic' has errors

[[90m12:01:00 AM[0m] Skipping build of project '/src/tests/tsconfig.json' because its dependency '/src/logic' has errors
...
[[90m12:04:00 AM[0m] Project 'src/core/tsconfig.json' is up to date because newest input 'src/core/anotherModule.ts' is older than oldest output 'src/core/tsconfig.tsbuildinfo'

[[90m12:04:00 AM[0m] Project 'src/logic/tsconfig.json' is out of date because buildinfo file 'src/logic/tsconfig.tsbuildinfo' indicates that some of the changes are not emitted
...
[[90m12:04:00 AM[0m] Project 'src/tests/tsconfig.json' can't be built because its dependency 'src/logic' has errors

[[90m12:04:00 AM[0m] Skipping build of project '/src/tests/tsconfig.json' because its dependency '/src/logic' has errors
